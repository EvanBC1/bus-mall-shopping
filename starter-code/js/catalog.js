...
var cart = new Cart([],[]);
var cartElement = document.getElementById('itemCount');
var cartCount = 0;
...
function populateForm() {
  ...
  for (var i in Product.allProducts) {
    selectElement.options[selectElement.options.length] = new Option(Product.allProducts[i].name);
  }
...
function addSelectedItemToCart() {
  ...
  var pickedItem = document.getElementsByTagName('option')[selectedItem].value;
